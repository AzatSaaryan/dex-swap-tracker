...
export declare function getDataBaseUrl(apiKey: string): string;
...
export declare const EthersNetwork: {
    ...
    "settlus-mainnet": string;
    "settlus-septestnet": string;
    "gensyn-testnet": string;
    "superseed-mainnet": string;
    "superseed-sepolia": string;
    "tea-sepolia": string;
    "anime-mainnet": string;
    "anime-sepolia": string;
    "story-mainnet": string;
    "story-aeneid": string;
    "megaeth-testnet": string;
    "botanix-mainnet": string;
    "botanix-testnet": string;
    "humanity-mainnet": string;
    "rise-testnet": string;
    "hyperliquid-mainnet": string;
};
/**
